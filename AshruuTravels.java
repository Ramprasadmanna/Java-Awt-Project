package praticals.ashruutravels;
...
public class AshruuTravels extends Frame implements ActionListener, ItemListener {
    ...
    AshruuTravels() {
        setSize(1910, 900);
        setTitle("Ashruu Travels");
        setLayout(null);
        setVisible(true);

        // Heading
        heading = new Label("Ashruu Travels", Label.CENTER);
        heading.setBounds(0, 50, 1500, 50);
        heading.setFont(new Font("Helvetica", Font.BOLD, 35));
        add(heading);

        // Form Labels
        // Journey Information
        journeyInfo = new Label("Journey Information", Label.CENTER);
        journeyInfo.setBounds(500, 100, 200, 30);
        journeyInfo.setFont(new Font("Helvetica", Font.BOLD, 15));
        add(journeyInfo);

        bookingDetails = new Label("Booking Details");
        bookingDetails.setBounds(1000, 100, 200, 30);
        ...
        destination.add("Kashmir");
        destination.add("Bhopal");
        destination.add("Pune");
        destination.add("Nagpur");
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        if (Source.equals("Select") || Destination.equals("Select")) {
            ...
            availableSeats.setText("5 Seats Available");
    ...
    void setTicketDetails(BookingDetails ticket) {
        ...
        phonenoOP[ticket.getBookingID()].setBounds(1225, 200 + (ticket.getBookingID() * 50), 85, 30);
        genderOP[ticket.getBookingID()].setBounds(1310, 200 + (ticket.getBookingID() * 50), 85, 30);
